...
ORYX.Plugins.AbstractPlugin = Clazz.extend({
    ...
    */
    ...
    /**
     * Sets the editor in slaver only mode: Edges/ dockers cannot be moved anymore,
    ...
    /**
     * Disables slaver only mode, see @see
     * @methodOf ORYX.Plugins.AbstractPlugin.prototype
...
ORYX.Plugins.RenameShapes = Clazz.extend({
	...
	actOnDBLClick: function(evt, shape){
		...
		// from these, get all properties where master access are and the type is String or Expression
