				...
				columns : [
...

                    {
						...
						formatter:function (value,row,index) {
                            var e = '<a   href="/activiti/process/resource/slaver/xml/'+row.id+'"  title="xml" target="_blank">xml</a> ';
                            return e;
                        }
                    },
                    {
                        ...
                        title : '流程XML',
                        formatter:function (value,row,index) {
                            var e = '<a   href="/activiti/process/resource/slaver/image/'+row.id+'"  title="图片" target="_blank">图片</a> ';
                            return e;
                        }
                    },
					{
